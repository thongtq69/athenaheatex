...
const settingFields=[['siteName','Tên website','text'],['logo','Logo đầu trang','image'],['logoLink','Trang mở khi bấm logo','text'],['favicon','Biểu tượng tab trình duyệt','image'],['navLinks','Menu chính','links'],['socialLinks','Liên kết mạng xã hội','links'],['phone','Điện thoại','text'],['mobile','Di động','text'],['fax','Fax','text'],['email','Email','email'],['secondaryEmail','Email phụ','email'],['whatsapp','WhatsApp (kèm mã quốc gia)','text'],['address','Địa chỉ','textarea'],['copyright','Copyright','text'],['defaultSeo.title','SEO title mặc định','text'],['defaultSeo.description','Meta description mặc định','textarea'],['defaultSeo.keywords','Meta keywords mặc định','textarea']];
