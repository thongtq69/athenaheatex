...
const SOCIAL_IMAGE_URL = `${PUBLIC_SITE_ORIGIN}/athena-heatex-share-preview.png`;
...
export function renderSocialMeta($, pathname = '/') {
  ...
  setSocialMeta($, 'property', 'og:image:type', 'image/png');
  setSocialMeta($, 'property', 'og:image:width', '2048');
  setSocialMeta($, 'property', 'og:image:height', '682');
