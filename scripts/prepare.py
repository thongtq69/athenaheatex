...
.inquiry-contact-channels{padding:16px 25px 6px;background:#f7fbfe;border:1px solid #e2edf4;border-width:0 1px;box-sizing:border-box}
.inquiry-contact-channels ul{display:flex;flex-wrap:wrap;align-items:center;margin:0;padding:0}.inquiry-contact-channels .contact-channel-item{float:none!important;display:block!important;width:auto!important;flex:0 0 auto}.inquiry-contact-channels .contact-channel-label{color:#333}
...
.floating-call-icon{position:relative;display:inline-flex;align-items:center;justify-content:center;width:50px;height:50px;margin-left:16px;border-radius:50%;background:#fff;color:#1687d5;box-shadow:0 0 0 3px rgba(22,135,213,.28);flex:0 0 auto;animation:floating-call-pulse 2.3s ease-in-out infinite}
.floating-call-icon::before{content:"";position:absolute;inset:-11px;border:2px solid #1687d5;border-radius:50%;pointer-events:none;animation:floating-call-ring 1.2s ease-in-out infinite}
.floating-call-icon svg{position:relative;z-index:1;width:29px;height:29px;fill:currentColor;transform-origin:50% 50%;animation:floating-call-shake 1s ease-in-out infinite}
@keyframes floating-call-ring{0%{transform:scale(.55);opacity:.1}30%{transform:scale(.8);opacity:.55}100%{transform:scale(1.18);opacity:0}}
@keyframes floating-call-pulse{0%,100%{box-shadow:0 0 0 3px rgba(22,135,213,.25)}50%{box-shadow:0 0 0 9px rgba(22,135,213,.12)}}
@keyframes floating-call-shake{0%,50%,100%{transform:rotate(0)}10%,30%{transform:rotate(-24deg)}20%,40%{transform:rotate(24deg)}}
@media screen and (max-width:768px){.floating-call{right:14px;bottom:60px;min-height:48px;padding-left:17px;font-size:16px}.floating-call-icon{width:42px;height:42px;margin-left:12px}.floating-call-icon svg{width:24px;height:24px}}
@media screen and (max-width:380px){.floating-call{font-size:14px;letter-spacing:0}}
@media (prefers-reduced-motion:reduce){.floating-call{transition:none}.floating-call-icon,.floating-call-icon::before,.floating-call-icon svg{animation:none}}
"""
